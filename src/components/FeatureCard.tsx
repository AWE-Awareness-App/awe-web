...
const FeatureCard: React.FC<FeatureCardProps> = ({ title, description, ctaText, imageSrc, onCtaClick }) => {
    return (
        <div className={`rounded-xl p-6 flex flex-col justify-between border-2 shadow-md relative h-[320px]`}>
            ...
            <div className="md:mt-4">
                <button onClick={onCtaClick} className="p-3 text-blue-700 rounded-full hover:bg-gray-200 hover:text-orange-500 transition flex items-center gap-2">
